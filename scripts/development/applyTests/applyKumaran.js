...
const targetJob = {
    ...
    location: 'Chennai',
    experience: '0-1 Yrs',
    jobUrl: 'https://www.naukri.com/job-listings-devops-engineer-kumaran-systems-pvt-ltd-chennai-0-to-1-years-040926504669?src=drecomm_profile&sid=17889480753598651&xp=5&px=1'
};

async function main() {
    console.log(chalk.bold.cyan('\n╔══════════════════════════════════════════════════════════════╗'));
    console.log(chalk.bold.cyan('║   Kumaran Systems — Devops Engineer Apply Bot (External)     ║'));
    console.log(chalk.bold.cyan('╚══════════════════════════════════════════════════════════════╝\n'));
